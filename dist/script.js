...
var modals = function modals() {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        document.body.style.overflow = 'hidden'; // document.body.classList.add('modal-open') // bootstrap class
      });
    });
  ...
  bindModal('.popup_calc_profile_button', '.popup_calc_end', '.popup_calc_close', false); // showModalByTime('.popup', 60000);
};
...
var timer = function timer(id, deadline) {
  var addAZero = function addAZero(num) {
    if (num <= 9) {
      return '0' + num;
    } else {
      return num;
